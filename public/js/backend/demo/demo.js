...
//        });
    ...
    $(document).on('click','.confirmF',function(e){
...
$(document).on('click','.cancel-order',function(){
    var oderID = $(this).attr('data-order-id');
    $.ajax({
        url: '/frontend/order/ajaxDeleteOrder',
        data :{orderId: oderID},
        type : 'POST'
    }).done(function(data){
        window.location.replace("/frontend/order/add");
    });
