 ...
 * MenuStore
 *
 * @ORM\Table(name="menu_store", uniqueConstraints={@ORM\UniqueConstraint(name="name", columns={"name"})})
 * @ORM\Entity
 */
class MenuStore
{
     ...
     * @var float
     *
     * @ORM\Column(name="out_of_stock", type="float", precision=10, scale=0, nullable=true)
     */
    private $outOfStock;
